...
public class Hotel implements Serializable {
    ...
    private static int Standardquantity = 1;
    private static int Superiorquantity = 1;
    private static int Deluxequantity = 1;
    private static int Suitequantity = 1;
    private static int Presidentquantity = 1;
    private static int RoyalSuitequantity = 1;
    private static int Bungalowquantity = 1;
